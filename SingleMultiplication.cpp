...
{
    setIO("");
    freopen("SingleMultiplicationMeters.txt","r",stdin);
    freopen("singleMultiplicationTheivesForUnderstanding.txt","w",stdout);
    srand ( time(NULL) );
    ...
    cout<<" Data will be from now on : times (6) , then range (3 to 10) mf (0.3 to 0.8) "<<endl;
